...
public partial class MainWindow : Window
{
    ...
    /// CLI flag (typically passed by Stage).
    /// </summary>
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        _copilotHost = new TerminalHostControl(AgentDisplayName, $"Frame-Agent-{instanceId}");
        _consoleHost = new TerminalHostControl("Console", $"Frame-Console-{instanceId}");
